...
public interface UserRoleControllerOpenApi {
	...
	public ResponseEntity<Void> grant(
			@Parameter(description = "ID of a user", example = "821e3c67-7f22-46af-978c-b6269cb15387") Long userId,
			@Parameter(description = "ID of a role", example = "18aace1e-f36a-4d71-b4d1-124387d9b63a") Long roleId);
	...
	public ResponseEntity<Void> revoke(
			@Parameter(description = "ID of a user", example = "821e3c67-7f22-46af-978c-b6269cb15387") Long userId,
			@Parameter(description = "ID of a user role", example = "18aace1e-f36a-4d71-b4d1-124387d9b63a") Long roleId);
}
